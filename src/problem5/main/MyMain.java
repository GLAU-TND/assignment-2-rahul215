...
public class MyMain {
    public static void main(String[] args) {
        ...
        studentList.add(new Student(4, "Divya", 6, 3));
        studentList.add(new Student(5, "Eisha", 0, 0));
        studentList.add(new Student(6, "Faizan", 4, 2));
        studentList.add(new Student(7, "Gaurang", 2, 1));
        studentList.add(new Student(8, "Harshraj", 1, 1));
        studentList.add(new Student(9, "Ishita", 0, 0));
